...
<script type="text/javascript">
	...
	{
		if (task == 'booking.cancel' || document.formvalidator.isValid(document.id('flight-form')))
		{
...
<form action="<?php JRoute::_('index.php?option=com_flights&id=' . (int)$this->item->id); ?>" method="post" name="adminForm" id="flight-form" class="form-validate">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
		...
		<div class="row-fluid">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('flight_id'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('flight_id') ?></div>
			</div>
			<div class="control-group">
