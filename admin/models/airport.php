...
class FlightsModelAirport extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_flights.airport';		
	 ...
	 */
	public function getTable($type = 'Airport', $prefix = 'FlightsTable', $config = array())
	{
