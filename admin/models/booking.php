...
class FlightsModelBooking extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_flights.booking';		
	 ...
	 */
	public function getTable($type = 'Booking', $prefix = 'FlightsTable', $config = array())
	{
